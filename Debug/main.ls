 ...
 244                     ; 52 }
 248  0009 81            	ret
 278                     ; 54 static void TIM1_pwm_setup(void) {
 279                     .text:	section	.text,new
 280  0000               L3_TIM1_pwm_setup:
 284                     ; 55 	TIM1_DeInit();
 286  0000 cd0000        	call	_TIM1_DeInit
 288                     ; 56 	TIM1_TimeBaseInit(0, TIM1_COUNTERMODE_UP, 99, 0);
 ...
 298                     ; 57 	TIM1_OC1Init(TIM1_OCMODE_PWM2, 
 298                     ; 58 							 TIM1_OUTPUTSTATE_ENABLE, 
 298                     ; 59 							 TIM1_OUTPUTNSTATE_DISABLE,
 298                     ; 60 							 0,
 298                     ; 61 							 TIM1_OCPOLARITY_HIGH,
 298                     ; 62 							 TIM1_OCNPOLARITY_LOW,
 298                     ; 63 							 TIM1_OCIDLESTATE_RESET,
 298                     ; 64 							 TIM1_OCNIDLESTATE_RESET);
 ...
 311                     ; 66 	TIM1_OC2Init(TIM1_OCMODE_PWM2, 
 311                     ; 67 							 TIM1_OUTPUTSTATE_ENABLE, 
 311                     ; 68 							 TIM1_OUTPUTNSTATE_DISABLE,
 311                     ; 69 							 50,
 311                     ; 70 							 TIM1_OCPOLARITY_HIGH,
 311                     ; 71 							 TIM1_OCNPOLARITY_LOW,
 311                     ; 72 							 TIM1_OCIDLESTATE_RESET,
 311                     ; 73 							 TIM1_OCNIDLESTATE_RESET);
 ...
 324                     ; 75 	TIM1_OC3Init(TIM1_OCMODE_PWM2, 
 324                     ; 76 							 TIM1_OUTPUTSTATE_ENABLE, 
 324                     ; 77 							 TIM1_OUTPUTNSTATE_DISABLE,
 324                     ; 78 							 100,
 324                     ; 79 							 TIM1_OCPOLARITY_HIGH,
 324                     ; 80 							 TIM1_OCNPOLARITY_LOW,
 324                     ; 81 							 TIM1_OCIDLESTATE_RESET,
 324                     ; 82 							 TIM1_OCNIDLESTATE_RESET);
 ...
 404  0010 85            	popw	x
 405  0011 81            	ret
 440                     ; 102 void assert_failed(uint8_t* file, uint32_t line)
 440                     ; 103 { 
